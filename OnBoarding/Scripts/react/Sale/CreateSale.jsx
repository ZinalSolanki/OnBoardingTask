...
export default class CreateSale extends Component {
    constructor(props) {
        ...
        this.CustomerDropdown = this.CustomerDropdown.bind(this);
        this.ProductDropdown = this.ProductDropdown.bind(this);
        this.StoreDropdown = this.StoreDropdown.bind(this);
    ...
    render() {
        ...
        let StoreDataList = [{ Id: '', StoreName: 'Select Store' }].concat(this.state.StoreDropdownList)
